...
class Article
{
     ...
     * 
     * @param object Connection to the DB
     ...
     *
     * @param object $conn Connection added to the database
    ...
    /**
     * Update the article with its current proprety values
     *
     * @param object $conn Connection to the DB
     *
    ...
    /**
     * Insert a new article with its current proprety values
     *
     * @param object $conn Connection to the DB
     *
     * @return boolean True if the delete was successful, false otherwise
     ...
     */
    public function setImageFile($conn, $filename) //Not static because we'll call it on an article object
    {
        $sql = "UPDATE article
